...
export const PLACEHOLDER_CATALOG: PlaceholderGroup[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { token: 'pressaoTesteAltaEquipSup', label: 'Teste alta equipamentos de pressão (SL, WL e FT)' },
    ],
  },
  {
    id: 'testes_pressao',
    ...
    fields: [
      { token: 'pressaoOverbalanceStvR275', label: 'Overbalance p/ retirada de STV (nipple R 2,75")' },
      { token: 'pressaoOverbalanceStvF281', label: 'Overbalance p/ retirada de STV (nipple F 2,81")' },
      { token: 'pressaoOverbalancePlugR275', label: 'Overbalance p/ retirada de plug (nipple R 2,75")' },
      { token: 'pressaoOverbalancePlugF281', label: 'Overbalance p/ retirada de plug (nipple F 2,81")' },
      { token: 'pressaoEstColunaVgl', label: 'Estanqueidade da coluna (instalação de VGL)' },
      { token: 'pressaoEstTampaoBd', label: 'Estanqueidade do tampão mecânico (bombeio direto)' },
      { token: 'pressaoIntegridadeColunaPlt', label: 'Integridade da coluna (perfilagem PLT)' },
      { token: 'pressaoEstBppCabo', label: 'Estanqueidade do BPP (cabo, modo BOP)' },
      { token: 'pressaoEstPlugFtF281', label: 'Estanqueidade do plug — FT (nipple F 2,81")' },
      { token: 'pressaoEstPlugFtR275', label: 'Estanqueidade do plug — FT (nipple R 2,75")' },
      { token: 'pressaoTesteNegPlugTh', label: 'Teste negativo do plug no TH (FT)' },
      { token: 'pressaoEstStvFtF281', label: 'Estanqueidade da STV — FT (nipple F 2,81")' },
      { token: 'pressaoEstStvFtR275', label: 'Estanqueidade da STV — FT (nipple R 2,75")' },
      { token: 'pressaoEstBppColuna', label: 'Estanqueidade do BPP (coluna de trabalho)' },
      { token: 'pressaoTestePacker', label: 'Teste de pressão (packer de operação)' },
      { token: 'pressaoLinhasSupCr', label: 'Teste de linhas de superfície (recimentação c/ CR)' },
      { token: 'pressaoEstPocoFcba', label: 'Estanqueidade do poço c/ FCBA' },
      { token: 'pressaoEstPlugTmfProd', label: 'Estanqueidade do plug no TMF (bore de produção)' },
      { token: 'pressaoEstPlugTmfAnul', label: 'Estanqueidade do plug no TMF (bore de anular)' },
    ],
  },
  {
    id: 'nipples',
